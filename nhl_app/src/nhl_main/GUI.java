...
/**
 * TODO: Skaalautuvat listat, "Pelaajaprofiili" kun valitsee pelaajan, Kalenterikomponentin lis채ys -> PelitAikavalilla
 * 
 * Ohjelman GUI
 * @author v,j
 *
	...
	public GUI() throws IOException {
	    ...
	    joukkueBox.addListSelectionListener(new ListSelectionListener() {
	    	public void valueChanged(ListSelectionEvent arg0) {
	    		...
	    		// Tyhjennet채채n lista mahd. aikaisemmista pelaajista
	    		pelaajatModel.clear();
	    		...
	    		// Otetaan joukkueen nimest채 viimeisen sanan lis채ksi my철s viimeist채 edelt채v채 -> "red" + "wings"
	    		...
	    		try {
					pelaajat = pelaajaLista.getLista(); //pyydet狎n oliolta pelaajalistaa
				} catch (IOException e) {
					e.printStackTrace();
				}
	    		
	    		// Lis채t채채n pelaajat GUIn listaan
